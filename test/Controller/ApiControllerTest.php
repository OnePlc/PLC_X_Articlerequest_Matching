...
use OnePlace\Articlerequest_Matching\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/articlerequest_Matching/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/articlerequest_Matching/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('articlerequest_Matching-api');
    }
}
