<?php
/**
 * Articlerequest_MatchingControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Articlerequest_Matching Module
 *
 * @category Test
...
namespace OnePlaceTest\Articlerequest_Matching\Controller;

use OnePlace\Articlerequest_Matching\Controller\Articlerequest_MatchingController;
...
class Articlerequest_MatchingControllerTest extends AbstractHttpControllerTestCase {
    public function setUp() : void {
        ...
        $this->setApplicationConfig([
            ...
            'modules' => ['OnePlace\Articlerequest_Matching'],
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/articlerequest_Matching', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('articlerequest_Matching');
        $this->assertControllerName(Articlerequest_MatchingController::class); // as specified in router's controller name alias
        $this->assertControllerClass('Articlerequest_MatchingController');
        $this->assertMatchedRouteName('articlerequest_Matching');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/articlerequest_Matching/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('articlerequest_Matching');
        $this->assertControllerName(Articlerequest_MatchingController::class); // as specified in router's controller name alias
        $this->assertControllerClass('Articlerequest_MatchingController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/articlerequest_Matching/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('articlerequest_Matching');
        $this->assertControllerName(Articlerequest_MatchingController::class); // as specified in router's controller name alias
        $this->assertControllerClass('Articlerequest_MatchingController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/articlerequest_Matching/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('articlerequest_Matching');
        $this->assertControllerName(Articlerequest_MatchingController::class); // as specified in router's controller name alias
        $this->assertControllerClass('Articlerequest_MatchingController');
